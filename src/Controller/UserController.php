<?php
    ...
    class  UserController {
        ...
        public function register($username, $password) {
            $db = new DB("localhost", "Admin", "Sumafelo03!", "php_lms");
            $isql = "INSERT INTO `users` (`user_id`, `username`, `password`, 'firstname', 'lastname',  'email')VALUES (NULL, :username, :password)";
        ...
        public function login($username, $password) {
            $db = new DB("localhost", "Admin", "Sumafelo03!", "php_lms");
            $ssql = "SELECT username, password FROM users WHERE username = ? AND password = ?";
